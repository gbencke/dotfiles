function _summarize_yt {
  ...
  gemini -p "/model temperature 0 \n Please summarize in maximum detail this transcript: @$TITLE_VIDEO.en.srt" > $TITLE_VIDEO.summary.md
...
function _summarize_pdf {
  ...
  gemini -p "/model temperature 0 \n Please summarize in maximum detail this pdf: \"@$1\"" > $FINAL_FILE.md
