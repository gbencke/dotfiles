...
#NONINTERACTIVE
    ...
    sudo pacman -Sy --noconfirm rsync ranger go 
    ...
    pip2 install autopep8 pylint virtualenv pmm cython pillow lxml pdftotext chardet
    pip install autopep8 pylint virtualenv pmm cython pillow lxml pdftotext chardet 
